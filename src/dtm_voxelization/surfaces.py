...
fan-triangulated from the first corner (exact for convex polygons).
"""

import meshio
import numpy as np

from .mesh import read_hex_mesh
...
def run(case):
    """Write each surface, aligned, to `surfaces/<name>.stl` for inspection."""
